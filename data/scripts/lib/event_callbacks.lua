...
EVENT_CALLBACK_BUFF_ADD = 31
 EVENT_CALLBACK_BUFF_UPDATE = 32
 EVENT_CALLBACK_BUFF_REMOVE = 33
 EVENT_CALLBACK_LAST = EVENT_CALLBACK_BUFF_REMOVE
...
local callbacks = {
	...
	["onSpawn"] = EVENT_CALLBACK_ONSPAWN,
 	["onBuffAdd"] = EVENT_CALLBACK_BUFF_ADD,
 	["onBuffUpdate"] = EVENT_CALLBACK_BUFF_UPDATE,
 	["onBuffRemove"] = EVENT_CALLBACK_BUFF_REMOVE
}
